...
declare namespace Components {
    ...
    namespace Schemas {
        ...
        export interface CreatePostRequestV2 {
            content: string;
            inReplyTo?: string;
            assets?: string[];
        }
...
declare namespace Paths {
    ...
    namespace CreateBroadcastV2 {
        export type RequestBody = Components.Schemas.CreatePostRequestV2;
        namespace Responses {
            export type $200 = Components.Schemas.BroadcastExtended;
            export type $401 = Components.Responses.UnauthorizedError;
        }
    ...
    namespace UploadAsset {
        export type RequestBody = Components.Schemas.UploadAssetRequest;
        namespace Responses {
            export type $200 = Components.Schemas.UploadAssetResponse;
        }
    }
...
export interface OperationMethods {
  /**
   * uploadAsset - Create a new post
   */
  'uploadAsset'(
    parameters?: Parameters<UnknownParamsObject> | null,
    data?: Paths.UploadAsset.RequestBody,
    config?: AxiosRequestConfig  
  ): OperationResponse<Paths.UploadAsset.Responses.$200>
  /**
  ...
  /**
   * getFeedV2 - Get the Live Feed for the current user, paginated
   */
  'getFeedV2'(
    parameters?: Parameters<UnknownParamsObject> | null,
    data?: any,
    config?: AxiosRequestConfig  
  ): OperationResponse<Paths.GetFeedV2.Responses.$200>
  /**
   * postBroadcastWebhook - Webhook for new broadcasts
   */
  ...
  /**
   * createBroadcastV2 - Create a new post
   */
  'createBroadcastV2'(
    parameters?: Parameters<UnknownParamsObject> | null,
    data?: Paths.CreateBroadcastV2.RequestBody,
    config?: AxiosRequestConfig  
  ): OperationResponse<Paths.CreateBroadcastV2.Responses.$200>
  /**
