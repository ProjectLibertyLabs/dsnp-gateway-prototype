...
declare namespace Components {
    ...
    namespace Schemas {
        ...
        export interface InteractionTicket {
         ...
         */
        export type JsonLdContext = /* Either a string, or an array containing strings and objects with string values */ string | (string | {
            [name: string]: string;
        })[];
...
declare namespace Paths {
    ...
    namespace SubmitInteraction {
        export type RequestBody = Components.Schemas.InteractionRequest;
        namespace Responses {
            export type $200 = Components.Schemas.InteractionResponse;
            export type $401 = Components.Responses.UnauthorizedError;
        }
    }
...
export interface OperationMethods {
  ...
  /**
   * authAssert - Returns 204 No Content if the caller's token is valid, 401 Unauthorized if not
   */
  'authAssert'(
    parameters?: Parameters<UnknownParamsObject> | null,
    data?: any,
    config?: AxiosRequestConfig  
  ): OperationResponse<Paths.AuthAssert.Responses.$204>
  /**
  ...
  /**
   * getInteractionsFeed - Get the feed of posts with interaction tags of a given attribute set type and URL, paginated.
   */
  'getInteractionsFeed'(
    parameters?: Parameters<Paths.GetInteractionsFeed.QueryParameters> | null,
    data?: any,
    config?: AxiosRequestConfig  
  ): OperationResponse<Paths.GetInteractionsFeed.Responses.$200>
  /**
  ...
  /**
   * submitInteraction - Request attestation for a pseudonymous interaction claim
   */
  'submitInteraction'(
    parameters?: Parameters<UnknownParamsObject> | null,
    data?: Paths.SubmitInteraction.RequestBody,
    config?: AxiosRequestConfig  
  ): OperationResponse<Paths.SubmitInteraction.Responses.$200>
}
